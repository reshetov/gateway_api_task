...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    stub_request(:post, 'https://www.saltedge.com/api/v5/customers').
      to_return(status: 200, body: customer_body.to_json, headers: {})
    stub_request(:get, "https://www.saltedge.com/api/v5/accounts").
      to_return(status: 200, body: account_body.to_json, headers: {})
    stub_request(:get, "https://www.saltedge.com/api/v5/transactions").
      to_return(status: 200, body: transaction_body.to_json, headers: {})
  end
end
